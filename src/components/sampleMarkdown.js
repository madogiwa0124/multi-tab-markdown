export const TUTORIAL_MARKDOWN =
`## 特長
MTMは、タブ機能を持ったマークダウンエディタです。
タブで作成した投稿を管理出来るため複数の投稿を保持し、スムーズに移動できます。

## 基本的な使い方
投稿の作成や削除といった基本的な使い方を説明します。

### 新規作成
新規に投稿を行うには、タブの右端の**+**のマークをクリックしてください。

### 投稿の更新
投稿の更新を行うには、左のサイドバーから対象の投稿を選択しSAVEボタンをクリックします。
